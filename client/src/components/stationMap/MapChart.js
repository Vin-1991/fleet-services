...
function MapChart(props) {
  ...
  useLayoutEffect(() => {
    ...
    var paris = addCity(
      { latitude: 51.505772, longitude: -0.016460175 },
      "Paris"
    );
    var toronto = addCity(
      { latitude: 51.51397065, longitude: -0.09294031 },
      "Toronto"
    );
    var la = addCity(
      { latitude: 51.51782144, longitude: -0.096496865 },
      "Los Angeles"
    );
    var havana = addCity(
      { latitude: 51.50724437, longitude: -0.106237501 },
      "Havana"
    );
  ...
  return (
    <div id="mapChartDiv" style={{ width: "100%", height: "450px" }}>
